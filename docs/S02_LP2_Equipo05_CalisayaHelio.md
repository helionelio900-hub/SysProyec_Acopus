...
* **Rol o Aporte Realizado:** Desarrollador Backend & Integración de Controladores REST, DTOs y Excepciones Globales
...
2. **¿Cuál es el aprendizaje más importante que te llevas de la clase de hoy?**
   * La implementación del manejo global de excepciones con `@RestControllerAdvice` y la validación de DTOs con `@Valid`.

3. **¿Qué punto de la clase te resultó más confuso o te dejó con dudas?**
   * El mapeo avanzado con MapStruct para objetos DTO complejos.
