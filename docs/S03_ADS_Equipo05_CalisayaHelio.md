...
**Nombre del Archivo Entregable:** `S03_ADS_Equipo05_CalisayaHelio.pdf`
...
4. **¿Por me la relación entre transacciones y minero no es una violación de `ModularityTests`?**
